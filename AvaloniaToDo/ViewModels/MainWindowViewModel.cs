...
namespace AvaloniaToDo.ViewModels
{
    public partial class MainWindowViewModel : ObservableObject
    {
        ...
        public MainWindowViewModel()
        {
            ...
            ItemsObservableCollectionVm.Add(new ToDoItem("Заглушка для теста") {Description = "ASDF", IsCompleted = true});
            ItemsObservableCollectionVm.Add(new ToDoItem("Заглушка для теста") {Description = "пкропрпаропа", IsCompleted = false});
            ItemsObservableCollectionVm.Add(new ToDoItem("Заглушка для теста") {Description = "гншщдорбтаппукп уцеу ф", IsCompleted = true});
        }
